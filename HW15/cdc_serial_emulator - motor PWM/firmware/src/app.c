    ...
    switch(appData.state)
    {
        ...
        case APP_STATE_CHECK_CDC_READ:
            ...
            if(appData.isReadComplete == true)
            {
                ...
                // STORES CHARS WAITING UNTIL NEWLINE CHAR IS RECVD
                int ii;
                ...
                else if ((qq>50)&(qq<=150)) {
                    OC2RS = 6000;
                    OC1RS = 1000;
                }
                else if((qq>150)&(qq<=300)) {
                    OC2RS = 5000;
                    OC1RS = 1000;
                }
                else if((qq>300)&(qq<=340)) {
                    OC1RS = 3000;
                    OC2RS = 3000;
                }
                else if((qq>340)&(qq<=490)) {
                    OC1RS = 5000;
                    OC2RS = 1000;
                }
                else if((qq>490)&(qq<=590)) {
                    OC1RS = 6000;
                    OC2RS = 1000;
                }
                else {
...
//                if(qq <320) {
//                    OC2RS = 4000;
//                    float duty1 = qq*4000.0/320.0;
//                    OC1RS = (int) duty1;
//                    
//                }
//                else {
//                    OC1RS = 4000;
//                    float duty2 = qq*4000.0/320.0;
//                    OC2RS = (int) duty2;
//                    
//                }
